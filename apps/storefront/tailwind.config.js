  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        // NOOORS motion
        "hero-ken-burns": "heroKenBurns 18s cubic-bezier(0.65,0,0.35,1) forwards",
        grain: "grain 8s steps(10) infinite",
        "fade-up": "fadeUp 1s cubic-bezier(0.65,0,0.35,1) forwards",
        marquee: "marquee 30s linear infinite",
        "float-y": "floatY 8s ease-in-out infinite",
        "float-y-slow": "floatY 12s ease-in-out infinite",
