...
export const Text = forwardRef<HTMLParagraphElement, TextProps>(
  ({ className, as: Component = "p", children, ...props }, ref) => {
    return (
      <Component
        ref={ref}
        className={clsx("text-base font-sans text-ink", className)}
        {...props}
      >
        {children}
      </Component>
  ...
  ({ className, level: Component = "h2", children, ...props }, ref) => {
    return (
      <Component
        ref={ref}
        className={clsx(
          "font-serif font-light tracking-tight text-ink leading-[1.1]",
          Component === "h1" && "text-4xl small:text-5xl",
          Component === "h2" && "text-3xl small:text-4xl",
  ...
  (
    ...
    return (
      <button
        ...
        className={clsx(
          "btn focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gold focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
    ...
    return (
      <div className="flex flex-col gap-1">
        ...
        <input
          ref={ref}
          className={clsx(
            "flex h-11 w-full bg-transparent border-0 border-b border-ink/15 rounded-none px-0 py-2 font-sans text-sm text-ink placeholder:text-smoke/60 focus:outline-none focus:border-gold transition-colors disabled:opacity-50",
            className
          )}
          {...props}
        />
