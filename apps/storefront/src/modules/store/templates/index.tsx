 ...
 * Hero copy + image come from the `siteContent` module (key: "store_hero"),
...
const StoreTemplate = async ({
  ...
  const heroContent = (await getSiteContent()).store_hero
      ...
      {heroContent && (
        ...
        >
          ...
          <div className="relative z-[2] text-center max-w-2xl px-6 pt-20">
            ...
            <p className="font-serif italic font-light text-ivory/80 mt-3 text-base">
